    ...
    function createCard(name, siteLink, imageLink, index) {
        ...
        card.innerHTML = `
            <div class="card position-relative w-100">
                ...
                <button class="edit-btn" onclick="editCard(${index})"><i class="fas fa-edit"></i></button>
                <div class="card-body d-flex flex-column justify-content-center align-items-center">
                    <h5 class="card-title text-center">${name}</h5>
                    

                    <a class="cta btn" href="${siteLink}" target="_blank">
    ...
    function editCard(index) {
        ...
        // Ocultar o botão de adicionar ao organizador
        document.getElementById('addButton').style.display = 'none';

        // Desabilitar outros botões de edição
        const editButtons = document.querySelectorAll('.edit-btn');
        editButtons.forEach(button => {
            button.disabled = true;
        });

        // Adicionar o índice do card ao botão de salvar mudanças
    ...
    function saveChanges() {
        ...
        // Atualizar o card no localStorage
        let cards = JSON.parse(localStorage.getItem('cards')) || [];
        cards[index] = { name, siteLink, imageLink };
        localStorage.setItem('cards', JSON.stringify(cards));

        // Recarregar os cards
        loadCards();

        // Limpar o formulário e esconder os botões de cancelar e salvar edição
        ...
        // Mostrar o botão de adicionar ao organizador novamente
...
// verificar depois os códigos -------------------------------------------------------------------------



// Função para reativar os botões de edição
...
function editCard(index) {
    ...
    // Desabilitar outros botões de edição
    enableEditButtons(); // Ativar os botões de edição antes de desativar o atual
...
document.getElementById('copyLinkButton').addEventListener('click', function() {
    const shareLink = window.location.href; // Obtém o link atual da página
...
// Função para mostrar o campo de inserir o link para acessar os cards de outra pessoa
document.getElementById('openLinkFieldButton').addEventListener('click', function() {
    document.getElementById('linkFieldContainer').style.display = 'block';
});

// Evento para redirecionar para o link inserido no campo
document.getElementById('linkField').addEventListener('change', function() {
